...
const showForProcessRunCreateFromScratch = {
...
export const processRunCreateFromScratchDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    displayOptions: {
      show: showForProcessRunCreateFromScratch,
    },
  },
  {
    ...
    displayOptions: {
      show: {
        ...showForProcessRunCreateFromScratch,
        method: ["published"],
      },
    },
    typeOptions: {
...
function buildCreateFromScratchBody(this: IExecuteFunctions): IDataObject {
...
export async function processRunCreateFromScratch(
  this: IExecuteFunctions,
): Promise<INodeExecutionData[]> {
  const body = buildCreateFromScratchBody.call(this);
...
export default processRunCreateFromScratchDescription;
