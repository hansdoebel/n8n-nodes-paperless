...
export const documentDuplicateDescription: INodeProperties[] = [
  {
    ...
    description:
      "ID of the workspace the duplicated document will be placed in",
  },
  {
    ...
    description: "ID of the document to duplicate",
  },
  {
    displayName: "Name",
    name: "name",
    ...
    description: "Name of the duplicated document",
  },
  {
